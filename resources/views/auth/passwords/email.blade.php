...
<head>
    ...
    <title>Memory Master - Reset Password</title>
...
<body>
    ...
    <div class="game-container">
        <h1 class="game-title">RESET PASSWORD</h1>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="game-input-group">
                <input id="email" type="email" placeholder="Your Email" name="email" required autofocus>
            ...
            <a href="{{ route('login') }}" class="game-link">Back to Login</a>
        </form>
    </div>
</body>
</html>