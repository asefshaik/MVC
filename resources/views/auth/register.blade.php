...
<head>
    ...
    <title>Memory Master - Register</title>
...
<body>
    ...
    <div class="game-container">
        <h1 class="game-title">JOIN THE GAME</h1>
        
        <form method="POST" action="{{ route('register') }}">
            @csrf

            <div class="game-input-group">
                <input id="name" type="text" placeholder="Player Name" name="name" required autofocus>
            ...
            <a href="{{ route('login') }}" class="game-link">Already have an account? Login</a>
        </form>
    </div>
</body>
</html>